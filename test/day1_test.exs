defmodule Advent.Day1Test do
  ...
  describe "find_repeated" do
    test "input 1" do
      assert 0 == Day1.find_repeated(0, ~w(+1 -1))
    end

    test "input 2" do
      assert 10 == Day1.find_repeated(0, ~w(+3 +3 +4 -2 -4))
    end

    test "input 3" do
      assert 5 == Day1.find_repeated(0, ~w(-6 +3 +8 +5 -6))
    end

    test "input 4" do
      assert 14 == Day1.find_repeated(0, ~w(+7 +7 -2 -7 -4))
    end
  end
end
